...
function collect_ios_product() {
    ...
    local flutter_framework="${flutter_build_soures}/Flutter.framework"
    local plugin_h="${basePath}/ios/Runner/GeneratedPluginRegistrant.h"
    local plugin_m="${basePath}/ios/Runner/GeneratedPluginRegistrant.m"
    local cp_list=($app_framework $flutter_framework)
    ...
    mkdir -p ${product_dir}/Flutter/FlutterPluginRegistrant
    
    echo "拷贝$plugin_h 到 ${product_dir}/Flutter/FlutterPluginRegistrant/GeneratedPluginRegistrant.h"
    cp -fr $plugin_h ${product_dir}/Flutter/FlutterPluginRegistrant/GeneratedPluginRegistrant.h
    
    echo "拷贝$plugin_m 到 ${product_dir}/Flutter/FlutterPluginRegistrant/GeneratedPluginRegistrant.m"
    cp -fr $plugin_m ${product_dir}/Flutter/FlutterPluginRegistrant/GeneratedPluginRegistrant.m

    local flutterPluginRegistrant_m="${product_dir}/Flutter/FlutterPluginRegistrant/GeneratedPluginRegistrant.m"
